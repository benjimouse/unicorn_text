...
// Simple polling cache (in-memory only; consider using Firestore or Redis for persistent scheduling)
const activePolls = new Map();

router.post('/', allowOAuthOnly, async (req, res) => {
  ...
  // Then repeat for the desired number of minutes
